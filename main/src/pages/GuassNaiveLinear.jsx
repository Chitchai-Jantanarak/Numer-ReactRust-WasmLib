...
import init, { guass_naive } from '../wasm/cal_core.js';
import katex from 'katex';
import 'katex/dist/katex.min.css';

function GuassNaiveLinear() {
    ...
    const calculateGuass = async () => {
        try {
            ...
            const guassResult = guass_naive(mat_input, size, ans);
    ...
    return (
        <>
            <motion.div className="GuassNaiveLinear" 
                initial = {{ scale: 0.45 }} 
                animate = {{ scale: 1, x: 0, transition: { duration: 0.5, ease: 'circOut' } }}
            >
                <h1> Guassian Naive Elimination </h1>
...
export default GuassNaiveLinear;